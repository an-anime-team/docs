...
Keyword Value Example %launcher% Path to the launcher folder where its data is stored \$HOME/.local/share/anime-game-launcher %build% Path to Wine build (where folders bin, lib and so on are stored) \$HOME/.local/share/anime-game-launcher/runners/lutris-GE-Proton8-7-x86_64 %prefix% Path to Wine prefix \$HOME/.local/share/anime-game-launcher/prefix %game% Path to the folder where the game is installed \$HOME/.local/share/anime-game-launcher/game %temp% Path to the temporary directory used by the luncher \$HOME/.local/share/anime-game-launcher Game launcher #Keywords available only in the field with the game launch command.
