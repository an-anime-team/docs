...
Limitations #It is known that now the game does not have access to the pipewire/pulsaudio sound session, so you will not be able to hear the sounds inside the game. This will be fixed in future updates. `}),e.add({id:42,href:"/docs/launcher/enhancements/environment/",title:"Environment",description:"sus",content:`sus
